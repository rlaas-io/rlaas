...
// Store is a placeholder for postgres counter persistence.
type Store struct {
	DSN string
}

// New creates a postgres counter store scaffold.
func New(dsn string) *Store {
	return &Store{DSN: dsn}
}

func (s *Store) Increment(_ context.Context, _ string, _ int64, _ time.Duration) (int64, error) {
	return 0, errors.New("postgres counter store scaffold: implement SQL counters")
}
...
func (s *Store) Set(_ context.Context, _ string, _ int64, _ time.Duration) error {
	return errors.New("postgres counter store scaffold: implement SQL counters")
}

func (s *Store) CompareAndSwap(_ context.Context, _ string, _, _ int64, _ time.Duration) (bool, error) {
	return false, errors.New("postgres counter store scaffold: implement SQL counters")
}
...
func (s *Store) AcquireLease(_ context.Context, _ string, _ int64, _ time.Duration) (bool, int64, error) {
	return false, 0, errors.New("postgres counter store scaffold: implement SQL counters")
}
